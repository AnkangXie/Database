    ...
    public class MainWindowModel : NotifyBase
    {
        ...
        public MenusChecked MenusChecked
        {
            ...
            set
            {
                ...
                {
                    case MenusChecked.LivePage:
                        Page = PageManager.livePage;
                        break;
                    ...
                    case MenusChecked.SongListOfDayPage://每日推荐歌曲列表
                        ...
                        break;
                    case MenusChecked.SearchPage:
                        Page= PageManager.searchPage;
                        break;
                }
                DoNotify();
            }
        ...
        private string _login_username="游客";
