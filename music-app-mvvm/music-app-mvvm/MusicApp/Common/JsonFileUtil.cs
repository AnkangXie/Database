...
namespace MusicApp.Common
{
    public static class JsonFileUtil  //配置INI文件读写API
    {
        ...
        // 检查是否符合特定格式的方法
        public static bool IsDesiredFormat(JToken mv)
        {
            return mv["id"] != null &&
                   mv["cover"] != null &&
                   mv["name"] != null &&
                   ...
                   mv["subed"] != null &&
                   mv["artists"] != null &&
                   mv["artists"].HasValues &&
                   mv["artists"][0]["id"] != null &&
                   mv["artists"][0]["name"] != null &&
                   mv["artists"][0]["alias"] != null &&
                   mv["artists"][0]["transNames"] != null;
        }
    }
}
